...
return [
    ...
    'description' => 'Complete RESTful API for the Day News Multisite platform. Includes authentication, publishing, CRM, social features, e-commerce, ticketing, and more.',
    ...
    'type' => 'static', // Changed to static to generate MD files
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by registering a user via `/api/v1/auth/register` or logging in via `/api/v1/auth/login`.',
    ],
