...
return [
    ...
    'business_discovery' => [
        ...
        'throttle_ms' => env('NEWS_WORKFLOW_THROTTLE_MS', 100),
        ...
        'dense_categories' => [
            ...
            'doctor', 'dentist', 'lawyer', 'church', 'hair_salon', 'beauty_salon',
            'grocery_store', 'clothing_store', 'hotel', 'school', 'real_estate_agency',
        ],
        'sparse_categories' => [
