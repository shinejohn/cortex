...
□ Every CRITICAL issue has a corresponding fix in the git diff
□ Every HIGH issue has a corresponding fix in the git diff
□ No CRITICAL or HIGH issues remain in "issues_remaining"
