        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <a
            ...
            className="flex flex-col items-center p-3 rounded-lg hover:bg-gray-50 transition-colors">
              ...
              <div
              className={`w-10 h-10 ${platform.color} rounded-full flex items-center justify-center text-white mb-2`}>
      ...
      <div className="px-6 pb-6">
        ...
        <div className="space-y-3">
          ...
          <a
            key={index}
            href={group.url}
            className="block p-3 border border-gray-200 rounded-lg hover:border-news-primary hover:bg-news-primary-light hover:bg-opacity-5 transition-colors">
      ...
      <div className="bg-gray-50 px-6 py-4">
        ...
        <div className="flex">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 rounded-l-md focus:ring-news-primary focus:border-news-primary" />
