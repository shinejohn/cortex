...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('story_thread_articles', function (Blueprint $table) {
            ...
            $table->unique(['story_thread_id', 'news_article_id']);
        ...
        Schema::create('story_follow_up_triggers', function (Blueprint $table) {
            ...
            /*
            Examples:
            time_based: {"days_after_last": 3, "max_checks": 5}
            engagement_threshold: {"min_views": 1000, "min_comments": 50}
            date_event: {"date": "2025-02-15", "event": "Court hearing", "days_before": 1}
            external_update: {"keywords": ["John Smith", "manslaughter"], "sources": ["court_records"]}
            resolution_check: {"check_keywords": ["found", "located", "arrested"]}
            */
        ...
        Schema::create('story_beats', function (Blueprint $table) {
            ...
            // Linked article
            $table->uuid('news_article_id')->nullable();          // Article covering this beat
