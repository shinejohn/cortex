...
final class NewsSource extends Model
{
    ...
    protected $fillable = [
        ...
        'platform_profile_id', 'detected_platform_slug', 'platform_detected_at',
    ];
    ...
    {
        return $this->hasMany(CollectionMethod::class, 'source_id');
    }

    public function rawContent()
    {
        return $this->hasMany(RawContent::class, 'source_id');
    }
