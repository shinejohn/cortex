        ...
        <div className="flex flex-col gap-8">
            ...
            {memorials.length > 0 && (
                <Card className="overflow-hidden border-none shadow-md bg-zinc-900 text-white">
                    ...
                    <CardContent className="pt-6">
                        ...
                        <Button variant="ghost" className="w-full mt-6 text-zinc-400 hover:text-white hover:bg-white/5 text-xs font-bold uppercase tracking-widest">
                            View All Memorials
            ...
            <Card className="border-none shadow-sm bg-blue-50/50 border-blue-100">
                <CardHeader className="pb-2">
                    <CardTitle className="text-sm font-black uppercase tracking-widest flex items-center gap-2 text-blue-900">
                ...
                <CardContent>
                    ...
                    <Button variant="link" className="p-0 h-auto text-blue-600 font-bold text-xs uppercase tracking-widest">
            ...
            <Card className="border-none shadow-sm">
                ...
                <CardContent>
                        ...
                        {upcomingEvents.length > 0 ? upcomingEvents.map((event) => (
                            <div key={event.id} className="flex gap-4 group cursor-pointer">
                                <div className="flex flex-col items-center justify-center size-12 rounded-lg bg-muted shrink-0 text-center font-bold">
                                    <span className="text-[10px] uppercase leading-none text-muted-foreground">{event.month}</span>
                    ...
                    {upcomingEvents.length > 0 && (
                        <Button variant="outline" className="w-full mt-6 text-xs font-bold uppercase tracking-widest">
                            Browse Calendar
                        </Button>
                    )}
                </CardContent>
            ...
            <div className="rounded-xl bg-gradient-to-br from-primary/10 to-blue-500/10 p-6 border border-primary/10">
                ...
                <h3 className="font-bold text-lg mb-2">Celebrate Together</h3>
                <p className="text-sm text-muted-foreground mb-4">Sharing announcements helps build a stronger, more connected community.</p>
                <Button className="w-full font-black uppercase tracking-wider text-xs shadow-lg shadow-primary/20">
