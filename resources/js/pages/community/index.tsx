...
import type { CommunityIndexPageProps, Community } from "@/types/community";
import {
    UsersIcon,
    MessageCircleIcon,
    ArrowRightIcon,
...
export default function CommunityIndex() {
    const {
        ...
        communities = [],
        showcaseData = [],
    } = usePage<CommunityIndexPageProps>().props;
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="mt-2 text-muted-foreground">
                                Join conversations and connect with like-minded
                                people in our community discussions.
                            </p>
                        </div>
                        <Button
                            onClick={() => router.visit("/community/impact")}
                            variant="outline"
                    ...
                    {communities.length === 0 ? (
                        <div className="bg-card rounded-lg p-8 text-center border border-border">
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">
                                Communities will appear here once they are
                                created.
                            </p>
                        </div>
                    ) : (
