...
import { ArrowLeft, Calendar, Image as ImageIcon, MapPin, Megaphone, Upload, Plus, Info, CheckCircle2 } from "lucide-react";
            ...
            <div className="min-h-screen bg-[#FDFCFB]">
                ...
                <SEO
                    ...
                    data={{
                        ...
                        description: "Share a community milestone or announcement",
                            ...
                            <form onSubmit={handleSubmit} className="space-y-10">
                                <section className="space-y-8 rounded-3xl border bg-white p-8 shadow-sm">
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-muted-foreground font-medium">Define what your announcement is about.</p>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Textarea
                                            ...
                                            placeholder="Write your announcement details here. Be clear and include all necessary information."
                                            required
                                        />
                                ...
                                <section className="space-y-8 rounded-3xl border bg-white p-8 shadow-sm">
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-muted-foreground font-medium">Optional details to help your community find you.</p>
                                    </div>
                                        ...
                                        <div className="grid gap-6 md:grid-cols-2">
                                            ...
                                            {form.data.image ? (
                                                <div className="relative rounded-2xl overflow-hidden border shadow-inner bg-zinc-200 aspect-video">
                                                    <img src={URL.createObjectURL(form.data.image)} alt="Preview" className="h-full w-full object-cover" />
                                                    <button
                                                        type="button"
