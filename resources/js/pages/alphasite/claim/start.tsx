                ...
                <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-card rounded-lg shadow p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                <label className="block text-sm font-medium text-foreground mb-2">Verification Method</label>
                                ...
                                {errors.verification_method && <p className="mt-1 text-sm text-destructive">{errors.verification_method}</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    placeholder="Enter verification code"
                                />
                                {errors.verification_code && <p className="mt-1 text-sm text-destructive">{errors.verification_code}</p>}
                            </div>
                            ...
                            <div className="flex space-x-4">
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="flex-1 bg-primary text-white py-2 px-4 rounded-md hover:bg-primary disabled:opacity-50"
                                >
