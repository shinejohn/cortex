...
interface BusinessEditProps {
    auth: Auth;
    business: any; // Define proper type
}

export default function BusinessEdit({ auth, business }: BusinessEditProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        patch(route('downtown-guide.dashboard.business.update'));
    };
    ...
    return (
        <DowntownGuideLayout
            ...
            seo={{
                ...
                description: "Manage your business detailed information",
            }}
        >
