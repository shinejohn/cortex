...
export default function CouponEdit({ auth, coupon }: CouponEditProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('downtown-guide.dashboard.coupons.update', coupon.id));
    };

    const handleDelete = () => {
        destroy(route('downtown-guide.dashboard.coupons.destroy', coupon.id));
    };
    ...
    return (
        <DowntownGuideLayout
            ...
            seo={{
                title: "Edit Coupon",
                description: "Edit your coupon details",
            }}
        >
                        ...
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <AlertDialog>
                                    <AlertDialogTrigger asChild>
                                        <Button variant="destructive">Delete Coupon</Button>
                                    </AlertDialogTrigger>
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                            ...
                            <form onSubmit={submit} className="space-y-6 max-w-2xl">
                                ...
                                <div className="flex justify-end space-x-4">
                                    <Link href={route('downtown-guide.dashboard.coupons.index')}>
