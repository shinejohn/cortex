            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mt-4 text-lg text-gray-600">Discover, review, and engage with local businesses</p>
                    </div>
                    ...
                    <div className="mt-12 grid gap-8 md:grid-cols-3">
                        ...
                        <div className="rounded-xl border-2 border-purple-200 bg-white p-6 shadow-lg">
                            ...
                            <h3 className="text-xl font-bold text-gray-900">Business Directory</h3>
                            <p className="mt-2 text-gray-600">Find local businesses with detailed profiles, hours, contact information, and more.</p>
                            <Link href={route("downtown-guide.businesses.index")} className="mt-4 inline-block text-purple-600 hover:text-purple-700">
                                Browse Businesses →
                            </Link>
                        </div>
                        ...
                        <div className="rounded-xl border-2 border-purple-200 bg-white p-6 shadow-lg">
                            ...
                            <p className="mt-2 text-gray-600">Read authentic reviews from real customers and share your own experiences.</p>
                        </div>
                        ...
                        <div className="rounded-xl border-2 border-purple-200 bg-white p-6 shadow-lg">
                            ...
                            <h3 className="text-xl font-bold text-gray-900">Deals & Coupons</h3>
                            <p className="mt-2 text-gray-600">Save money with exclusive deals and digital coupons from local businesses.</p>
                            <Link href={route("downtown-guide.coupons.index")} className="mt-4 inline-block text-purple-600 hover:text-purple-700">
                                View Deals →
                            </Link>
                        </div>
                    </div>
                ...
                {/* CTA Section */}
                <div className="border-t-4 border-purple-200 bg-gradient-to-r from-purple-600 to-pink-600 py-16">
