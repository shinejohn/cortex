        ...
        <div className="min-h-screen bg-card">
            ...
            <div className="bg-gradient-to-r from-indigo-700 to-purple-700 text-white py-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <h1 className="text-5xl font-display font-black tracking-tight mb-4">Join Our Team</h1>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <h2 className="text-3xl font-display font-black tracking-tight text-foreground text-center mb-12">Why Work at GoEventCity?</h2>
                ...
                {/* Open Positions */}
                <h2 className="text-3xl font-display font-black tracking-tight text-foreground mb-8">Open Positions</h2>
                <div className="space-y-4">
                    {jobs.map((job) => (
                        <Card key={job.id} className="group overflow-hidden border-none shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
                    <h2 className="text-3xl font-display font-black tracking-tight mb-4">Don't See a Role That Fits?</h2>
