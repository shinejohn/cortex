...
export default function EditCalendar() {
    ...
    const [formData, setFormData] = useState({
        ...
        update_frequency: calendar.update_frequency,
        subscription_price: calendar.subscription_price.toString(),
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post(route("calendars.update", calendar.id), formDataToSend, {
                headers: {
    ...
    return (
        <AppLayout>
            <Head title={`Edit ${calendar.title}`} />
            <div className="min-h-screen bg-background">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-6">
                        <Link href={route("calendars.show", calendar.id)}>
                        ...
                        <p className="text-muted-foreground mt-1">Update your calendar details</p>
                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    {calendar.image && imageFiles.length === 0 && (
                                        <div className="mt-2 mb-3">
                                            <p className="text-sm text-muted-foreground mb-2">Current image:</p>
                                            <img
                                                src={`/storage/${calendar.image}`}
                                                alt={calendar.title}
                                    ...
                                    <ImageUpload
                                        ...
                                        maxSize={5}
                                        label=""
                                        description="Drag and drop a new calendar cover image here, or click to select"
                                    />
                        ...
                        <Card className="border-destructive">
                            ...
                            <CardContent>
                                <p className="text-sm text-muted-foreground mb-4">
                                    Once you delete a calendar, there is no going back. Please be certain.
                                </p>
