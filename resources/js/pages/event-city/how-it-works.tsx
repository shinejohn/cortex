        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">For Event Goers</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    ...
                    <Card>
                        <CardContent className="p-6 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">2. Get Tickets</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div>
                            <div className="flex items-center mb-4">
                                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-indigo-100 text-indigo-600 flex items-center justify-center font-bold text-lg mr-4">
                                    1
                                </div>
                                <h3 className="text-xl font-semibold text-gray-900">Create Your Event</h3>
                            </div>
                        ...
                        <div>
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-gray-900">Promote & Share</h3>
                            </div>
                            <p className="text-gray-600 ml-14">
                        ...
                        <div>
                            <div className="flex items-center mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-gray-900">Manage & Analyze</h3>
                            </div>
                            <p className="text-gray-600 ml-14">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <Card>
                            <CardContent className="p-6">
                                <Bell className="h-8 w-8 text-indigo-600 mb-3" />
                        ...
                        <Card>
                            <CardContent className="p-6">
                                <Ticket className="h-8 w-8 text-indigo-600 mb-3" />
                                <h3 className="text-lg font-semibold text-gray-900 mb-2">Secure Ticketing</h3>
                                <p className="text-gray-600">
