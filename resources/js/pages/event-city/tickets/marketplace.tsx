                    ...
                    <div className="text-center">
                        ...
                        <form onSubmit={handleSearch} className="mt-8 max-w-3xl mx-auto">
                            <div className="relative">
                                ...
                                <Input
                                    type="text"
                                    className="block w-full pl-10 pr-3 py-4 border border-transparent rounded-md leading-5 bg-card placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white focus:border-white text-foreground"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm text-muted-foreground">
                        <div className="flex items-center">
                            <span className="font-semibold text-primary mr-2">{listings.meta.total}</span>
                            Events Available
                        </div>
                        <div className="flex items-center">
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <div className="font-bold text-lg text-foreground">${listing.price.toFixed(2)}</div>
                                                </div>
                                        ...
                                        <CardContent className="p-4 sm:p-6">
                                            <div className="flex flex-col sm:flex-row">
                                                <div className="sm:w-1/4 mb-4 sm:mb-0 sm:mr-6">
                                                    <div className="h-32 sm:h-full w-full rounded-md overflow-hidden bg-muted relative">
                                                        <img
                                                            src={
                                                                listing.event.image ||
                                                                "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=400&h=300&fit=crop"
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-4">
                                                        <div>
                                                            <h3 className="text-lg font-bold text-foreground mb-1">{listing.event.title}</h3>
                                                            <div className="flex items-center text-sm text-muted-foreground mb-1">
                                                                <Calendar className="h-4 w-4 mr-1 flex-shrink-0" />
