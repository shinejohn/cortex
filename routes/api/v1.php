...
Route::prefix('v1')->middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    // AI Creator & Moderation routes
    if (file_exists(__DIR__.'/v1/ai-creator.php')) {
        require __DIR__.'/v1/ai-creator.php';
    }
    ...
    // Provisioning (CRM Bridge)
    Route::post('/provision/subscription', [App\Http\Controllers\Api\V1\ProvisioningController::class, 'provisionSubscription']);
