    ...
    private function seedPlatforms(): void
    {
        $platforms = [
            ...
            [
                'id' => \Illuminate\Support\Str::uuid(),
                'name' => 'granicus_media',
                'display_name' => 'Granicus MediaManager',
                'description' => 'Meeting video streaming platform with RSS feeds for agendas, minutes, and video archives',
                'api_base_url' => null, // Uses subdomain pattern: {city}.granicus.com
                'detection_patterns' => json_encode([
                    'url_patterns' => ['.granicus.com', 'ViewPublisher.php', 'MediaPlayer.php'],
                    'html_signatures' => ['granicus', 'govmeetings', 'mediaplayer'],
                ]),
                'default_config' => json_encode([
                    'publisher_endpoint' => '/ViewPublisher.php?view_id={view_id}',
                    'rss_patterns' => [
                    ...
                    'max_view_id_probe' => 50,
                    'poll_interval_minutes' => 120,
                    'content_types' => ['meeting', 'agenda', 'minutes', 'video'],
                ]),
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
